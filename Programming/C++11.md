...
### move semantics
With rvalue reference, it looks like we can now use tempary objects. Tempary objects will still be destroied, they are just move from one object to another.
